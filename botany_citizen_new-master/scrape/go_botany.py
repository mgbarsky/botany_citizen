...
TARGET_ATTRIBUTES = ["Leaf type", "Leaf arrangement", "Number of sepals, petals or tepals",
                     "Fusion of sepals and petals", "Stamen number", "Fruit type (general)", "Flower description"]
