...
# or nominal values
def build_tree(answer_to_parent, rows, class_label_col, min_gain, is_single_val=False
    ...
    if gain < min_gain:  # to set up min gain
        ...
        if decision_node.class_id > 0 and gain != 0:  # when it's not the lowest level, and not all values are the same
